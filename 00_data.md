...
<a
href="https://github.com/sofeikov/bayesianfin/blob/main/bayesianfin/data.py#L136"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/sofeikov/bayesianfin/blob/main/bayesianfin/data.py#L130"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/sofeikov/bayesianfin/blob/main/bayesianfin/data.py#L124"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/sofeikov/bayesianfin/blob/main/bayesianfin/data.py#L116"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/sofeikov/bayesianfin/blob/main/bayesianfin/data.py#L103"
target="_blank" style="float:right; font-size:smaller">source</a>

### Variance

>  Variance (source_field:str, feature_name:str,
>                requested_lag:int|None=None, rolling_variance_window:int=3)

------------------------------------------------------------------------

<a
href="https://github.com/sofeikov/bayesianfin/blob/main/bayesianfin/data.py#L69"
target="_blank" style="float:right; font-size:smaller">source</a>

### QuantileTransformer

>  QuantileTransformer (source_field:str, feature_name:str,
>                           requested_lag:int|None=None, n_quantiles:int=1000,
...
<a
href="https://github.com/sofeikov/bayesianfin/blob/main/bayesianfin/data.py#L259"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/sofeikov/bayesianfin/blob/main/bayesianfin/data.py#L295"
target="_blank" style="float:right; font-size:smaller">source</a>
